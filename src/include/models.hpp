...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_1pl");
    reader.add_event(29, 29, "end", "model_1pl");
    return reader;
}

class model_1pl : public prob_grad {
private:
    int J;
    int K;
    int N;
    ...
    vector<int> y;
public:
    model_1pl(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_1pl_namespace::model_1pl";
        ...
        vals_i__ = context__.vals_i("j");
        pos__ = 0;
        size_t j_limit_0__ = N;
        for (size_t i_0__ = 0; i_0__ < j_limit_0__; ++i_0__) {
            j[i_0__] = vals_i__[pos__++];
        }
        ...
        for (int k0__ = 0; k0__ < N; ++k0__) {
            check_greater_or_equal(function__,"j[k0__]",j[k0__],1);
            check_less_or_equal(function__,"j[k0__]",j[k0__],J);
        }
        for (int k0__ = 0; k0__ < N; ++k0__) {
            check_greater_or_equal(function__,"k[k0__]",k[k0__],1);
            check_less_or_equal(function__,"k[k0__]",k[k0__],K);
        }
        for (int k0__ = 0; k0__ < N; ++k0__) {
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(cauchy_log<propto__>(sigma_beta, 0, 1));
            lp_accum__.add(bernoulli_logit_log<propto__>(y, subtract(stan::model::rvalue(theta, stan::model::cons_list(stan::model::index_multi(j), stan::model::nil_index_list()), "theta"),stan::model::rvalue(beta, stan::model::cons_list(stan::model::index_multi(k), stan::model::nil_index_list()), "beta"))));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_1pl_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(33, 33, "end", "model_2pl");
    return reader;
}

class model_2pl : public prob_grad {
private:
    int J;
    int K;
    int N;
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(theta, 0, 1));
            lp_accum__.add(lognormal_log<propto__>(alpha, 0.5, 1));
            lp_accum__.add(normal_log<propto__>(beta, mu_beta, sigma_beta));
            lp_accum__.add(normal_log<propto__>(mu_beta, 0, 1));
            lp_accum__.add(cauchy_log<propto__>(sigma_beta, 0, 1));
            lp_accum__.add(bernoulli_logit_log<propto__>(y, subtract(elt_multiply(stan::model::rvalue(alpha, stan::model::cons_list(stan::model::index_multi(k), stan::model::nil_index_list()), "alpha"),stan::model::rvalue(theta, stan::model::cons_list(stan::model::index_multi(j), stan::model::nil_index_list()), "theta")),stan::model::rvalue(beta, stan::model::cons_list(stan::model::index_multi(k), stan::model::nil_index_list()), "beta"))));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
